 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueRace extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueRace($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Native/Aboriginal','Caucasian','Africian','Latin','Asian','Other') as $value)
