 ...
 * @access 		public
 */
class XoopsFormSelectOptionType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectOptionType($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        $this->setCaption($caption);
        $this->setName($name);
        $this->_multiple = $multiple;
        $this->_size = intval($size);
		@$this->addOption('int', 'Integer');
		@$this->addOption('decimal', 'Decimal');
		@$this->addOption('varchar', 'Varchar(5000)');		
