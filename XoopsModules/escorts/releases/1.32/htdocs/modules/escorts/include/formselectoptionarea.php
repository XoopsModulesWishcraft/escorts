 ...
 * @access 		public
 */
class XoopsFormSelectOptionArea extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectOptionArea($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        $this->setCaption($caption);
        $this->setName($name);
        $this->_multiple = $multiple;
        $this->_size = intval($size);
		@$this->addOption('pictures', 'Pictures');
		@$this->addOption('prices', 'Prices');
		@$this->addOption('profile', 'Profile');
		@$this->addOption('urls', 'Urls');
		@$this->addOption('votes', 'Votes');
