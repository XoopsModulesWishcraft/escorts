 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueBodyHair extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueBodyHair($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Smooth','Moderate','Hairy','Shaved','Waxed') as $value)
