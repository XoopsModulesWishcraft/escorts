 ...
 * @access 		public
 */
class XoopsFormSelectPriceType extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPriceType($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Weekdays Day','Weekends Day','Weekday Evening','Weekend Evening','Weekday Night','Weekend Night','Morning Weekday','Morning Weekend') as $value)
