 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueEyes extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueEyes($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Amber Eyes','Blue Eyes','Brown Eyes','Gray Eyes','Green Eyes','Hazel Eyes','Red Eyes') as $value)
