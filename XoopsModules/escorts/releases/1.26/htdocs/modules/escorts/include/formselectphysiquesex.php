 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueSex extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueSex($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Male','Female','Transsexual') as $value)
