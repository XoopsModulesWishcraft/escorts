 ...
 * @access 		public
 */
class XoopsFormSelectSexuality extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectSexuality($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('Hetrosexual', ucfirst('Hetrosexual'));			
		$this->addOption('Homosexual', ucfirst('Homosexual'));			
		$this->addOption('Bisexual', ucfirst('Bisexual'));			
