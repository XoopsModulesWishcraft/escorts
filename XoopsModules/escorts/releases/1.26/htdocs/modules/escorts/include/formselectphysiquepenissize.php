 ...
 * @access 		public
 */
class XoopsFormSelectPhysiquePenisSize extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiquePenisSize($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Under 5in / 11cm','5 - 7in / 12cm - 16cm','7 - 9in / 18 - 24cm','10 - 13in / 25 - 31cm','Over 13in / 33cm') as $value)
