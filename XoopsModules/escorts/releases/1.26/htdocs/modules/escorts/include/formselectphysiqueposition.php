 ...
 * @access 		public
 */
class XoopsFormSelectPhysiquePosition extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiquePosition($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Top','Bottom','Verastile','Active','Passive','Top & Bottom','Top & Active','Bottom & Active','Top & Passive','Bottom & Passive') as $value)
