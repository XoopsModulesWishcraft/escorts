 ...
 * @access 		public
 */
class XoopsFormSelectPhysiquePhysique extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiquePhysique($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Slim','Athletic','Muscular','Average','Bear','Heavy') as $value)
