 ...
 * @access 		public
 */
class XoopsFormSelectYN extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectYN($caption, $name, $value = null, $size = 1, $multiple = false)
    {
        $this->setCaption($caption);
        $this->setName($name);
        $this->_multiple = $multiple;
        $this->_size = intval($size);
		$this->addOption('Yes', ucfirst('Yes'));		
		$this->addOption('No', ucfirst('No'));				
        if (isset($value)) {
            $this->setValue($value);
        }
    }
