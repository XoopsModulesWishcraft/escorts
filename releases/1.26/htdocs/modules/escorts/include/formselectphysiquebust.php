 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueBust extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueBust($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('A Cup','B Cup','C Cup','D Cup','E Cup','F Cup') as $value)
