 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueForeskin extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueForeskin($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Cut','Uncut') as $value)
