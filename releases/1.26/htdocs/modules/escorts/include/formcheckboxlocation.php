 ...
 * @access 		public
 */
class XoopsFormCheckBoxLocation extends XoopsFormElement
{
    /**
     * Availlable options
     *
     ...
     */
    function XoopsFormCheckBoxLocation($caption, $name, $value = null, $delimeter = '<br/>')
    {
		...
		foreach(escorts_LocationArray() as $id => $value)
