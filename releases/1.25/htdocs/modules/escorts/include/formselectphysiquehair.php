 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueHair extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueHair($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('Black Hair','Brown Hair','Auburn Hair','Red Hair','Blond Hair','Grey Hair','White Hair') as $value)
