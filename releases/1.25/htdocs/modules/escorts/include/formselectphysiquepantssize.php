 ...
 * @access 		public
 */
class XoopsFormSelectPhysiquePantsSize extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiquePantsSize($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('28in / 71cm','29in / 73cm','30in / 76cm','31in / 79cm','32in / 81cm','33in / 84cm','34in / 86cm','35in / 89cm','36in / 91cm','37in / 94cm','38in / 97cm','39in / 99cm','40in / 101cm','41in / 104cm','42in / 107cm','43in / 109cm','44in / 112cm','45in / 114cm','46in / 117cm') as $value)
