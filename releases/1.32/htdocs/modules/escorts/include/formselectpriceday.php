 ...
 * @access 		public
 */
class XoopsFormSelectPriceDay extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPriceDay($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		$this->addOption('Sunday', ucfirst('Sunday'));
		$this->addOption('Monday', ucfirst('Monday'));
		$this->addOption('Tuesday', ucfirst('Tuesday'));
		$this->addOption('Wednesday', ucfirst('Wednesday'));
		$this->addOption('Thursday', ucfirst('Thursday'));
		$this->addOption('Friday', ucfirst('Friday'));
		$this->addOption('Saturday', ucfirst('Saturday'));				
        if (isset($value)) {
            $this->setValue($value);
        }
    }
