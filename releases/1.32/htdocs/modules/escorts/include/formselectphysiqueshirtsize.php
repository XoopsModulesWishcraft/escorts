 ...
 * @access 		public
 */
class XoopsFormSelectPhysiqueShirtSize extends XoopsFormElement
{
    /**
     * Options
     *
     ...
     */
    function XoopsFormSelectPhysiqueShirtSize($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('', '-----------');
		foreach(array('14in / 36cm','14.5in / 37cm','15in / 38cm','15.5in / 39cm','16in / 41cm','16.5in / 42cm','17in / 43cm','17.5in / 44cm','18in / 45cm','18.5in / 46cm','19in / 48cm','19.5in / 50cm','20in / 51cm') as $value)
