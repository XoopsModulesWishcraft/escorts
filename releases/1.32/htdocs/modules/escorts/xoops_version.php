...
$modversion['templates'][12]['file'] = 'escorts_admin_edit_escort.html';
$modversion['templates'][12]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][13]['file'] = 'escorts_admin_edit_picture.html';
$modversion['templates'][13]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][14]['file'] = 'escorts_admin_edit_pictures.html';
$modversion['templates'][14]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][15]['file'] = 'escorts_admin_edit_url.html';
$modversion['templates'][15]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][16]['file'] = 'escorts_admin_edit_urls.html';
$modversion['templates'][16]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][17]['file'] = 'escorts_admin_escorts.html';
$modversion['templates'][17]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][18]['file'] = 'escorts_admin_edit_prices.html';
$modversion['templates'][18]['description'] = 'Escorts Edit (Admin)';
$modversion['templates'][19]['file'] = 'escorts_admin_edit_price.html';
...
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = XOOPS_ROOT_PATH.'/uploads/escorts/watermarks/default.ttf';
...
$modversion['config'][$i]['formtype'] = 'text';
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = XOOPS_ROOT_PATH.'/uploads/escorts/watermarks/default.png';
...
$modversion['config'][$i]['title'] = "_ESC_HTACCESS";
$modversion['config'][$i]['description'] = "_ESC_HTACCESSDESC";
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = '0';
?>